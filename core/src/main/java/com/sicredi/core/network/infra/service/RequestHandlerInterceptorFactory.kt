...
class RequestHandlerInterceptorFactory internal constructor() {
    fun createInterceptor(): Interceptor = RequestHandlerInterceptor()

    private class RequestHandlerInterceptor : Interceptor {
